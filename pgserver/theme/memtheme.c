/* $Id: memtheme.c,v 1.12 2000/11/05 05:08:19 micahjd Exp $
 * 
...
unsigned short thobj_ancestry[PGTH_ONUM] = {
  ...
  /* 39 PGTH_O_POPUP_MENUITEM        */ PGTH_O_BASE_INTERACTIVE,
  /* 40 PGTH_O_POPUP_MENUITEM_HILIGHT*/ PGTH_O_MENUITEM,
};

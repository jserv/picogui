/* $Id: opengl.h,v 1.3 2002/11/23 12:01:24 micahjd Exp $
 *
...
#include <picogui/constants.h>   /* For PG_GROP_USER */
...
#define PG_GROP_GL_FEEDBACK           0x301C   //!< params: filtering mode, source buffer, (mipmap flag:mipmap index)

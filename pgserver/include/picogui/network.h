/* $Id: network.h,v 1.42 2001/09/10 18:02:19 micahjd Exp $
 *
...
#define PG_PROTOCOL_VER    0x0009      /* Increment this whenever changes are made */
...
#define PGREQ_UNDEF        45  /* types > this will be truncated. return error */
